...
const Header = () => {
  const [text] = useTypewriter({
    words: [ "MERN STACK DEVELOPER", "React JS Developer","Node JS Developer","Frontend Developer","Backend Developer","Fullstack Developer"],
    loop: 0, 
    typeSpeed: 100,
    deleteSpeed: 50,
    delaySpeed: 1500,
        ...
        <div className="app__header-badge">
          <div className="badge-cmp app__flex">
            ...
            <div style={{ marginLeft: 20 }}>
              ...
              <p className="head-text">Sreeraj</p>
            </div>
          </div>
