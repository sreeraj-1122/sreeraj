...
import projects from "../../constants/projects"; // Adjust the path as needed
import "./Work.css";
...
const Work = () => {
  ...
  useEffect(() => {
    // Set the filter works to the projects data
  ...
  const handleFilter = (item) => {
    ...
    setTimeout(() => {
      ...
      if (item === "All") {
        ...
        setFilterWorks(projects.filter((work) => work.tags.includes(item)));
      }
    }, 500);
  };
  ...
  return (
    <>
      ...
      <div className="app__work-filter">
        {["All", "React Js", "MERN", "Html,Css,JavaScript"].map(
          (item, index) => (
            <div
              key={index}
